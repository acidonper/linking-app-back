...
There are implemented some express routes in order to expose required information. The following table provides an routes overview regard to their path and main objetive:
...
| /health | --     | ---          | GET    | N/A                    | Sanity Check message     | Test Express Health Status                                        |
