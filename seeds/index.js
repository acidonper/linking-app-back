...
const createUsers = () => {
  const userList = [
    {
      ...
      status: "active",
      photos: [
        "https://uc05965b71d8871e08ab1e365285.previews.dropboxusercontent.com/p/thumb/AAxbj6DhubyNq8e6wUwAlwBxVFlqrWn-9kAuXS_wj7rgFG753-SYGOsNuQFy717wf7ZCeR6qXNSpUJldxsy-5j95F_9i3g5LfTnmcL2p8YWjXXfql6CFmg1eant_sdkx3f6mhACtp59Xaff8eW5hcsDNCJk3IbywIm0QaHTlxcrr4RAv4PPE0bsUFbkMxHNptyMi2EIo5OLacDU4xOQGyL8Bax5LUzJ7HqLR4LuDaOLwWJFtCqvlU1iTIGqLbWA9bYOf-jHE5wbXblxQ0tCeuyuqgV2L0e-6wJW6Hd3HP3fJW_kUs-0cp9TjRC3nu5ksRPRUec5v2LsHoDrhCbE_Vek8M-GFA3i5eNM7Hg_lcooURMAJnDSjEmZNcYxcWRREJpHxZjrnN-H4Lne766Z9zIFw/p.jpeg?fv_content=true&size_mode=5",
      ],
      information: {
        age: 18,
        gender: "male",
    ...
    ,
    {
      ...
      status: "active",
      photos: [
        "https://uce4da4f3c904f92a376113f03ee.previews.dropboxusercontent.com/p/thumb/AAx7QO52mQz8lXyq9-1T9uR_HJcTisM5jNPkr9re1DSDNdbw1bLlQ15rWvss-HEtFGnNmUZSBRf5UzFkpujMNseex-GrsSZwJMnFXVny48OzYeUeHoov1P-rUd_SL4Muq0Aag9cZzik2z-hNMgtDgpTE4iW4PH1nj8wIfvrpoQTtD4sSqP1ASEqX9KqEVb41MkU6KdwvlC5lhB9UfTPvXEwGdrPEfF21Rfo5y9ikQ-wTlE5AAZmlC9cikDtn3zvKjcWNGVB9doEObj55xemxtnAP3x3_9NIsiV8WWsV_PTZW-9A9_Dpvf162heSeptZoxVtpCJQ0c8m-wRjdMPPO-hT6LYpbvpHCMU94Ep2wDsj7t-kM4WRwn9yv59d_IEHej-KE2qGbj4_66HmhRwGaVrXQ/p.png?fv_content=true&size_mode=5",
      ],
      information: {
        age: 19,
        gender: "female",
  ...
  userList.map(async (user) => {
    try {
      user.category = userCategorization(user.information, user.preferences);
